...
- 🎴 Full **52-card deck** (A–K × ♥ ♦ ♣ ♠)
- 🍜 Each card maps to a Vietnamese food
- 🎲 **Random draw button** with roulette-style animation
- ♠♥♦♣ **Unicode suit icons** (red/black styled)
- 📱 **Mobile-first layout**, optimized to fit as much as possible in one screen
- 🎨 Modern dark UI, compact and game-like
